...
class ParticleGrid:
    ...
    def __attrs_post_init__(self) -> None:
        r"""Perform unit and dimension checks on initialization."""
        self.check_dimension()
        self.check_units()

    def check_units(self) -> None:
        r"""Check the units of the grid center and return a valid unit."""
    ...
    def check_dimension(self) -> None:
        r"""Ensure the grid is 1D and has at least 2 grid points."""
    ...
    def log_center(self) -> NDArray:
        r"""Base-10 logarithm of the grid center, respecting signs."""
    ...
    def edge(self) -> Quantity:
        r"""Grid edges including the left-most and right-most boundaries."""
        center = (
